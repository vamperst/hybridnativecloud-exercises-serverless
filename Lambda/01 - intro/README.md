...
1. No terminal do IDE criado no cloud9 execute o comando `cd ~/environment/hybridnativecloud-exercises-serverless/Lambda/01\ -\ intro/` para entrar na pasta que fara este exercicio.
